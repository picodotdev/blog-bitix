...
{{< image
    gallery="true"
    image1="java-classpath.png" optionsthumb1="650x450" title1="Aplicación de ejemplo ejecutada con classpath"
...
{{< image
    gallery="true"
    image1="java-jar-uberjar.png" optionsthumb1="650x450" title1="Aplicación de ejemplo ejecutada con uberjar"

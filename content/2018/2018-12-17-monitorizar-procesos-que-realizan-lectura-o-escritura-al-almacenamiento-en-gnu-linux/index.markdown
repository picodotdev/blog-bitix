...
{{< image
    gallery="true"
    image1="awk.png" optionsthumb1="300x200" title1="Datos escritos al almacenamiento desde el inicio del sistema"
...
{{< image
    gallery="true"
    image1="awk-lifetime.png" optionsthumb1="300x200" title1="Datos escritos a una partición"
...
{{< image
    gallery="true"
    image1="iotop.png" optionsthumb1="300x200" title1="Datos escritos por procesos del sistema"
...
{{< image
    gallery="true"
    image1="firefox-config-1.png" optionsthumb1="300x200" title1="Configuración de Firefox optimizado para SSD"
    image2="firefox-config-2.png" optionsthumb2="300x200" title2="Configuración de Firefox optimizado para SSD"
...
{{< image
    gallery="true"
    image1="firefox-default.png" optionsthumb1="300x200" title1="Entrada y salida con las opciones de Firefox por defecto"
    image2="firefox-ssd.png" optionsthumb2="300x200" title2="Entrada y salida con opciones de Firefox optimizadas para SSD"
...
{{< image
    gallery="true"
    image1="gnome-monitor-del-sistema.png" optionsthumb1="300x200" title1="Monitor del sistema de GNOME"
...
{{< image
    gallery="true"
    image1="gnome-extension-system-monitor.png" optionsthumb1="300x200" title1="Extensión de GNOME de monitor del sistema"

...
Al final recurrí a un activador pero son inseguros, es mejor comprar una licencia de algunos de los vendedores alternativos a Microsoft. Microsoft vende las licencias de Windows a partir de 145 € para Windows 10 y de Microsoft Office a partir de 149 €, otros vendedores que se pueden encontrar en [Amazon][amazon] y [eBay][ebay] ofrecen licencias totalmente legales y mucho más baratas, de entre 10 € y 15 €. Una vez obtenido un código de la licencia hay que [activar Windows 10 y Microsoft Office][blogbitix-514].

* [Licencia de Windows 10 y Microsoft Office](https://www.microsoft.com/es-es/store/b/windows) en Microsoft.

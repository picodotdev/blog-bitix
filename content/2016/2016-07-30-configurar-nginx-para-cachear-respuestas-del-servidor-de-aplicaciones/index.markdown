...
{{< figureproc
    image1="nginx-cache-peticion-miss.png" thumb1="nginx-cache-peticion-miss-thumb.png" options1="2560x1440" optionsthumb1="450x400" title1="Fallo en la cache de Nginx"
    image2="nginx-cache-peticion-hit.png" thumb2="nginx-cache-peticion-hit-thumb.png" options2="2560x1440" optionsthumb2="450x400" title2="Acierto en la cache de Nginx" >}}
{{< figureproc
    image1="nginx-cache-peticion-expired.png" thumb1="nginx-cache-peticion-expired-thumb.png" options1="2560x1440" optionsthumb1="450x400" title1="Expiración en la cache de Nginx"
    image2="curl-cache-miss-hit-expired.png" thumb2="curl-cache-miss-hit-expired-thumb.png" options2="2560x1440" optionsthumb2="450x400" title2="Fallo, acierto y expiración en la cache de Nginx con curl"

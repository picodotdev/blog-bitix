...
{{< image
    gallery="true"
    image1="gnome-chess.png" optionsthumb1="300x200" title1="Icono del juego de ajedrez de GNOME"
...
{{< image
    gallery="true"
    image1="gnome-chess-tablero.png" optionsthumb1="300x200" title1="Juego de ajedrez de GNOME"
...
{{< image
    gallery="true"
    image1="gnome-chess-preferencias-juego.png" optionsthumb1="300x200" title1="Preferencias de juego de ajedrez de GNOME"
    image2="gnome-chess-preferencias-aspecto.png" optionsthumb2="300x200" title2="Preferencias de aspecto de ajedrez de GNOME"

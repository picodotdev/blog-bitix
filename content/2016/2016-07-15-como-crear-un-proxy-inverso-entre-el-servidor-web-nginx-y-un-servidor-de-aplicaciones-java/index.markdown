...
{{< image
    gallery="true"
    image1="resource:reverse-proxy.png" optionsthumb1="300x200" title1="Esquema de un proxy inverso"
...
{{< image
    gallery="true"
    image1="resource:nginx-tomcat.png" optionsthumb1="300x200" title1="Nginx configurado como proxy inverso de un servidor de aplicaciones Tomcat"

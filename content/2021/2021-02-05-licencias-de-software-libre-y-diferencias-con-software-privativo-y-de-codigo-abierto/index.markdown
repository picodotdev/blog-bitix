...
Las licencias de BSD consideran que las 4 libertades de las licencias de software libre del proyecto GNU en realidad limitan las libertades del usuario, ya que la licencia GPL obliga a distribuir todo el código usado junto a esto aunque tenga otra licencia de software libre y modificaciones con una licencia GPL de software libre.
...
Según las cláusulas que incluye la licencia las licencias BSD se clasifican en en 4, 3 o 2 cláusulas.
...
La Microsoft Public License es una licencia de código abierto que permite la distribución del software bajo las misma licencia y la modificación para un uso un uso privado. Tiene restricciones en cuanto a las marcas registradas.

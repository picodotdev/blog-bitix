...
Cada juego de la colección de Trine tiene algunas pequeñas diferencias aún siendo los conceptos básicos del original los mismos en todos, el más diferente es Trine 3 que adopta un modo de juego más en tres dimensiones y con más libertad de movimientos. Son juegos principalmente de plataformas, de aventuras, resolver puzles y con un pequeño componente de rol de elegir habilidades en cad personaje u objetos. Los juegos de Trine destacan por su apartado gráfico y banda sonora que incluso el primero de la colección tiene un nivel de detalles gráficos grande.

Debido a que son juegos ya con varios años en las diferentes tiendas digitales e cada plataforma se encuentra a un precio de unos pocos euros, los tres primeros se distribuyen como una colección siendo aún así bastante baratos.

{{< image
    gallery="true"
    image1="image:trine-1.jpg" optionsthumb1="300x200" title1="Pantalla inicial y menú"
    image2="image:trine-2.jpg" optionsthumb2="300x200" title2="Pantalla inicial y menú"
    image3="image:trine-3.jpg" optionsthumb3="300x200" title3="Pantalla inicial y menú" >}}
{{< image
    gallery="true"
    image1="image:trine-1-menu.jpg" optionsthumb1="300x200" title1="Pantalla inicial y menú"
    image2="image:trine-2-menu.jpg" optionsthumb2="300x200" title2="Pantalla inicial y menú"
    image3="image:trine-3-menu.jpg" optionsthumb3="300x200" title3="Pantalla inicial y menú"
...
{{< image
    ...
    caption="Inicios de nivel en Trine 2" >}}
...
{{< image
    ...
    image2="image:trine-3-arte-grafico-2.jpg" optionsthumb2="300x200" title2="Arte gráfico de Trine 3"
...
El juego se desarrolla con una pequeña historia lineal como hilo conductor al inicio de cada nivel que dan sentida a las aventuras de los personajes y niveles. No es una historia muy elaborada ni diferentes lineas argumentales pero completa con su papel en el juego con suficiencia.

{{< image
    gallery="true"
    image1="image:trine-1-historia.jpg" optionsthumb1="300x200" title1="Historia de Trine 1"
    image2="image:trine-2-historia.jpg" optionsthumb2="300x200" title2="Historia de Trine 2"
    image3="image:trine-3-historia.jpg" optionsthumb3="300x200" title3="Historia de Trine 3"
    caption="Historia de Trine 1, 2 y 3" >}}
{{< image
    gallery="true"
    image1="image:trine-1-narracion.jpg" optionsthumb1="300x200" title1="Narración al inicio de nivel de Trine 1"
    image2="image:trine-2-narracion.jpg" optionsthumb2="300x200" title2="Narración al inicio de nivel de Trine 2"
    image3="image:trine-3-narracion.jpg" optionsthumb3="300x200" title3="Narración al inicio de nivel de Trine 3"
    caption="Narración de Trine 1, 2 y 3" >}}
...
La banda sonora enriquece el juego estando a la altura del arte gráfico, completa el juego en el aspecto sonoro.

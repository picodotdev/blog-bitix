...
Según la dificultad varía el nivel de vida de los enemigos, la inflación que se aplica en el precio de los servicios y mercancías en los mercados o el número de vidas iniciales para resucitar a los personajes en caso de su muerte.
...
Hay un ciclo de día y de noche diferenciados en varios turnos, hay que planificar los viajes para hacer los combates durante el día ya que durante la noche los enemigos son algo más fuertes. En la barra de tiempo también se muestra si se acerca alguna plaga que si no se contrarresta desencadena algunos eventos que aumentan la dificultad, también está el nivel de caos que si no se reduce hace que el número de encuentros de enemigos por el mapa sea mayor.
...
Tanto las plagas como el caso es recomendable evitar que ocurran para que evitar dificultades añadidas a la partida.
...
* Velocidad: afecta a los puntos de movimiento del personaje por el tablero asi como la iniciativa en los encuentros que determina el orden de ataque de los personajes y de los enemigos.
...
A medida que los personajes van derrotando a enemigos gana puntos de experiencia, acumulados cierto número de puntos de experiencia se sube de nivel lo que mejora las estadísticas del personaje en el daño que hace, puntos de vida que tiene.
...
{{< image
    gallery="true"
    image1="image:inventario-1.jpg" optionsthumb1="300x250" title1="Inventario inicial herrera"
    image2="image:inventario-2.jpg" optionsthumb2="300x250" title2="Inventario inicial cazadora"
    image3="image:inventario-3.jpg" optionsthumb3="300x250" title3="Inventario inicial erudita"
...
Los combates es el modo alternativo a viajar por el mundo donde los personajes empiezan una lucha por turnos hasta que todos los enemigos mueren o todos los aventureros mueren momento en el que se acaba la partida. Los combates son como máximo entre los tres aventureros y tres enemigos, emboscando a los enemigos los combates pueden ser de los tres o dos aventureros contra un único enemigo, ocasionalmente algún combate es uno contra uno.
...
El orden en el combate se determina según la estadística de velocidad del personaje y del enemigo, en cada turno se puede elegir a cual de los enemigos atacar. En caso de que un personaje muera en un combate durante la partida se tiene ciertos puntos para revivir el personaje, el adquirir una devoción en un santuario otorga una resurrección pero al utilizarla se pierde la devoción.
...
#### Información de aventureros y enemigos

Tanto en el combate como en el viaje por el mundo cada icono ofrece información, el juego no explica que significa cada uno y en mi caso los he ido aprendiendo después de un par de partidas. En la pantalla del combate cada icono y número significa una cosa que es importante conocer, no saberlo significa malgastar turnos, no hacer daño a los enemigos, tener que consumir hierbas porque ellos nos hace mucho y si la cosas va muy mal un personaje quizá muera y haya que gastar una vida en resucitarlo.

En los aventureros cada uno tiene un panel de información, Alane tiene 6 puntos de foco y no tiene ninguno consumido, Ebrion tiene 5 pero solo 3 más por gastar. Alane tiene 16 puntos de armadura que protegen de 16 puntos de daño físico al recibir un ataque del enemigo, 11 puntos de resistencia que protegen de 11 puntos de daño mágico y un nivel de evasión de solo 10 cuando Ebrion tiene 26 en función de estos puntos a cada personaje le es posible esquivar los ataques con más facilidad. Alane tiene 75 puntos de vida restantes de un máximo de 154 que si llegan a 0 muere, también tiene 2549 puntos de experiencia y ha de llegar a 3200 para el siguiente nivel, el nivel que tiene ahora es el nivel 10. También se muestra los objetos y que número de ellos se tiene en el inventario. A la izquierda Alane y Ebrión tiene un icono morado que significa que tiene esa maldición que afecta negativamente a los personajes de diferente forma, son más lentos, hacen menos daño o baja la estadística de un atributo entre otras.

En la parte superior está la linea de tiempo de turno de combate, ahora es el turno de Ebrión, el siguiente turno es el de una Sombra y al siguiente el de la otra Sombra, después le tocará a Fiode y luego a Alane y así continuando en la linea de tiempo. Cuando un enemigo muere desaparece de la línea de tiempo.

Cada enemigo también tiene su propio panel de información que hay que analizar para encontrar cual es la mejor estrategia para acabar con ellos de la forma más efectiva para que los aventureros sufran el menor daño posible. La sombras tiene 86 puntos de vida cada una y El señor de las momias 180. Las sombras tiene una resistencia de 16 puntos mágicos y El señor de las mómias de 12 puntos de dao físico y de 16 puntos de daño mágico. Para que el ataque de un aventurero haga daño ha de superar la armadura del enemigo si hace daño físico y ha de superar la resistencia si hace daño mágico. el daño del ataque es restando de la armadura o resistencia. Las sombras son vulnerables al daño físico porque no tienen armadura, El señor de las momias tiene armadura pero es más vulnerable al daño físico ya que tiene mayor resistencia.

Los iconos tachados encima del panel de los aventureros y debajo de los enemigos son as inmunidades a aflicciones físicas o maldiciones que tiene los personajes. Las sombras son inmunes a la congelación, representado por tener el tercer icono tachado de sus inmunidades, pero El seño de las momias es vulnerable a la congelación.

En la parte central esta el panel de acciones, es el turno de Ebrión que tiene seleccionada la acción de ataque _Disparo de escarcha_, este ataque hace 48 de daño físico si se superan las 4 tiradas de habilidad de percepción al enemigo seleccionado que en ese momento es El señor de las momias, en el ataque Ebrión ha de hacer 4 tiradas con un porcentaje de precisión o probabilidad del 55% por ranura o tirada, el 55% es una baja con lo que es probable que Ebrión supere dos tiradas pero falle otras dos. La probabilidad de Ebrión de acierto es solo del 55% porque tiene una maldición que le está afectando al atributo de percepción que es precisamente el que usa para las tiradas de ataque con el arma que tiene equipada. Alane usa el atributo de fuerza y Fiode el de inteligencia. El arma de Ebrión tiene el efecto especial de congelación si al hacer las tiradas todas tienen éxito, pero dada la maldición que tiene solo superar todas las tiradas tiene una probabilidad solo del 9%. Si Ebrión hace las tiradas es probable que tenga un éxito parcial, acertando dos y fallando otras dos, por cada fallo obtenido el daño realizado será menor de 48 puntos de daño con una tirada sin fallos. El arma de Ebrión también ofrece otros dos tipos de ataque con otros efectos, daño, probabilidad y número de tiradas o ranuras a superar.
...
Con toda esta información el jugador debe decidir como afrontar los ataques, a que enemigo atacar en función de la efectividad del arma, armadura, resistencia e inmunidades del enemigo, sus puntos de vida, con que ataque, si gastar puntos de foco para garantizar el éxito, si gastar objetos del cinturón.

#### Encuentros y mazmorras

En el tablero aparecen encuentros de combate individuales en los que una vez matados a los enemigos y terminado el combate se vuelve al tablero. Algunas ubicaciones con mazmorras en los que se han de superar varios combates seguidos para salir con vida, antes de afrontar estos conviene que los personajes estén debidamente equipados con armas y hierbas, tener el nivel de personajes igual o superior al nivel de la mazmorra. Los encuentros se inician a iniciativa de los personajes pero algunos ocasionalmente son inesperados.
...
{{< image
    gallery="true"
    image1="image:encuentro-1.jpg" optionsthumb1="300x250" title1="Encuentro con Demonio de ascuas"
    image2="image:encuentro-2.jpg" optionsthumb2="300x250" title2="Encuentro con Fergus el Loco"
    image3="image:encuentro-3.jpg" optionsthumb3="300x250" title3="Encuentro con Seño de las momias"
...
* Usa los pergaminos de teletransportación, visión y portal cuando sea útiles. Los de visión por ejemplo permite descubrir localizaciones ocultas sin tener que explorarlas acercando un personaje a esa casilla.

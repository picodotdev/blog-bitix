...
{{% gist id="8371b84c3186540a2f7f" file="build-1.gradle" %}}
...
{{% gist id="8371b84c3186540a2f7f" file="Main-1.java" %}}
...
{{% gist id="8371b84c3186540a2f7f" file="Main-2.java" %}}

Al final de la aplicación deberemos llamar al método shutdown del registro.

{{% gist id="8371b84c3186540a2f7f" file="Main-3.java" %}}
...
{{% gist id="8371b84c3186540a2f7f" file="build-2.gradle" %}}
...
{{% gist id="8371b84c3186540a2f7f" file="GeneratorServiceImpl.java" %}}

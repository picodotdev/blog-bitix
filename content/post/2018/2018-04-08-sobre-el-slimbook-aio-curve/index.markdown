...
El AIO Curve y ONE son dos productos diferentes que entran en competencia en el mismo catálogo y en rango de precios, un equipo por estos motivos para mí que calificaré de prescindible. Hubiese actualizado el ONE a una generación de procesadores más nueva y añadido un monitor al catálogo. No se que éxito tendrá el AIO Curve, dudo que sea una opción tan popular como los [Slimbook PRO2](https://slimbook.es/pro-ultrabook-13-aluminio) o [Katana](https://slimbook.es/katana-2-ultrabook-de-aluminio), y sería curioso conocer los números de pedidos comparados con el ONE.

...
updated: 2018-03-17T19:15:00+01:00
language: "es"
sharing: true
comments: true
promoted: false
...
La marca Apple tiene un halo de idolatración, de que no hay nada mejor ya sea en el hardware o en el software y si se me permite de elitismo, superioridad, ir a contracorriente, tener algo diferenciativo o exclusividad. Por mi experiencia no creo que GNU/Linux hoy día tenga mucho envidiar, ni sea más difícil de instalar o usar, quizá un buen soporte de hardware desde el día 0 pero eso es consecuencia de la cuota de uso de GNU/Linux en el escritorio, aún así las cosas han mejorado mucho en la última década. ¿Quieres un equipo para trabajar sin preocuparte mucho de dedicarle tiempo a mantenerlo?, usa una versión LTS de [Ubuntu][ubuntu], ¿quieres una distribución con el software actualizado? Usa Arch Linux o una de sus derivadas.

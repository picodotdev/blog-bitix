...
¿Quieres un equipo para trabajar sin preocuparte mucho de dedicarle tiempo a mantenerlo?, usa una versión LTS de [Ubuntu][ubuntu], ¿quieres una distribución con el software actualizado? Usa Arch Linux o una de sus derivadas. ¿Quieres un equipo potente, configurable, ligero y bonito? Échale un vistazo a los Slimbook.

...
Si quieres conocer más en detalle los procesadores tanto de su historia, evolución y funcionamiento detallado la enciclopedia [El mundo de Bitman](https://amzn.to/2n7Ayuv) recoge en varios volúmenes una ingente cantidad de información. Por ejemplo, concretamente el volumen V cubre los materiales candidatos a emplearse en el futuro, los límites de los semiconductores actuales y el futuro en los procesadores:

...
<div class="media" style="text-align: center;">
    {{< figure pid="137" image1="twitter-apps.png" thumb1="twitter-apps-thumb.png" title1="Twitter Apps" caption="Twitter Apps" >}}
</div>
...
{{% gist id="1ffd00f5ef7941a0f91b4fa2a39c5795" file="ShareServiceImpl.java" %}}

...
<div class="media" style="text-align: center;">
    {{< figure pid="150" image1="gnome-terminal.png" thumb1="gnome-terminal-thumb.png" title1="Terminal de GNOME con el intérprete de comandos bash" caption="Terminal de GNOME con el intérprete de comandos bash" >}}
</div>

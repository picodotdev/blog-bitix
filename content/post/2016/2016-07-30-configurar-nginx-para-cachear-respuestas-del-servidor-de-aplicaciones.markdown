...
{{% gist id="9bc353ad2c84bfd320c4819f2a91b98c" file="nginx.conf" %}}
{{% gist id="9bc353ad2c84bfd320c4819f2a91b98c" file="docker-compose.yml" %}}
...
{{% gist id="9bc353ad2c84bfd320c4819f2a91b98c" file="Main.java" %}}
...
{{% gist id="9bc353ad2c84bfd320c4819f2a91b98c" file="nginx.out" %}}
{{% gist id="9bc353ad2c84bfd320c4819f2a91b98c" file="curl-cache.sh" %}}

...
Dos artículos para usuarios sin muchos conocimientos de como instalar [Windows][windows] o la distribución [Ubuntu][ubuntu] de [GNU][gnu]/[Linux][linux]. Explicando paso a paso y detalladamente de cuales son los pasos para realizar la instalación desde cero.
...
Que disfrutéis leyendo algunos de los artículos que publiqué y aprovechar para suscribiros con vuestro lector de _feeds_ preferidos a Blog Bitix para no perderos ninguno de los que publique en el siguiente semestre que posiblemente verse bastante sobre Java.

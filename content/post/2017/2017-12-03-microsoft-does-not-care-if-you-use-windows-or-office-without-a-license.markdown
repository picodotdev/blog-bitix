...
There are few but a few options to purchase a laptop without Windows or with some Linux distribution, good quality, good specifications and reasonably priced, one of them are [Slimbook][slimbook] laptops. In the blog of [KDE Blog]((http://www.kdeblog.com/)) there is an [article about an model of these laptops]((http://www.kdeblog.com/slimbook-tu-portatil-linux-de-calidad.html)) and [a video with a _unboxing_]((http://www.kdeblog.com/unboxing-de-mi-slimbook-con-kubuntu-15-04-y-plasma-5.html)).

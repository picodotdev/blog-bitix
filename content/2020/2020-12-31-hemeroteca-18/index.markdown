...
date: 2020-12-31T12:00:00+01:00
language: "es"
rss: true
sharing: true
comments: true
...
> Quizá alguien piense que escribo únicamente sobre herramientas y estas no son de interés. Realmente más que escribir sobre herramientas escribo sobre problemas en las aplicaciones y lo resuelvo con una herramienta concreta que es sobre la que escribo que da una más fácil solución al problema.
> Tendré varios efectos, pero también otras virtudes y tengo que valorar de lo que soy capaz si tengo oportunidad. Dos cosas de esas que soy capa es el propio blog y el script alis que es posiblemente el mejor _script_ para instalar Arch Linux en el mundo de forma sencilla y rápida.

Una cosa es escribir artículos de ejemplo y otra usarlos en una empresa que factura unos cuantos cientos de millones de euros cuyo servicio es considerado crítico en producción. Por ejemplo, algo como la autenticación de los usuarios con [Keycloak][keycloak] no es sencillo implementarlo e integrarlo en una organización con numerosos sistemas ya funcionando, o implementar un segundo factor de autenticación, o un sistema para realizar las traducciones, o definir una autoridad de certificación, o disponer de una arquitectura de referencia en grado de producción de las aplicaciones [Consul][consul], [Vault][vault] y [Nomad][nomad] de [HashiCorp][hashicorp]. No solo es usarlo hay que mantenerlo, definir un plan para realizar copias de seguridad de las bases de datos y un plan para realizar actualizaciones de versiones sin que afecte al servicio. Así que los artículos quizá estén muy bien pero hay algunas cosas más a tener en cuenta para aplicarlos en un caso de producción en un organización, no solo para tener éxito al aplicarlos sino también por coraje en la organización para implementarlos.

Aunque se comenta en la frase corta lapidaria que con esfuerzo todo se consigue, el libro completo es que el esfuerzo y trabajo no siempre te permite conseguir lo que propongas, el fracaso o un éxito pobre es lo normal. El esfuerzo, trabajo, dedicación, constancia, perseverancia y cosas parecidas ayudan pero también está el factor suerte o simplemente tener el amigo, conocido, contacto, enchufe adecuado o simplemente caerle bien a la persona correcta.

En vez de compartir podría estar leyendo libros y formándome más, cada artículo medianamente interesante supone gran parte de mi tiempo libre fuera del horario de trabajo. En algún momento estar de vacaciones tener la [PlayStation][playstation] con algunos juegazos comprados y por jugar como _The Last of Us_, _God of War_, la serie _Uncharted_, los varios _Trine_, _The Witcher 3_, un gran libro por leer como _The Unicorn Project_, alguna película por ver del estudio Ghibli o dar un paseo durante algunas horas pero en algunos momentos casi me apetece más escribir algún artículo para el blog.

No recibo muchos, aunque algunos que recibo son [como este comentario de agradecimiento](https://picodotdev.github.io/blog-bitix/2015/12/informacion-y-metricas-de-la-aplicacion-con-spring-boot-actuator/#comment-5185576930) que me alegra y me anima a seguir escribiendo. Algunos blogueros y más _youtubers_ comentan que en sus comentarios tiene algún _troll_ que comenta para criticar, que recuerde solo una persona me criticó algo por twitter con cierta parte de razón sobre algo del pirateo de Windows que comenté pero por otra no. Todavía no tengo un _troll_, será que mi blog no es de política ni hablo de los fascistas dirigentes de V🤮X o los corruptos dirigentes del PP ambos miserables igual que sus lacayos mercenarios en las redes sociales.
...
Por insertar un enlace contextual relevante para el contenido he recibido el pago de 20 €, de otros dos enlaces en otros dos artículos a razón de otros 20 € por enlace con un total de 40 € que instalé hace un par de años y que con cierto esfuerzo e insistencia por mi parte he conseguido finalmente cobrar. Por AdSense este 2020 he recibido 250 € y por Amazon con una facturación de 3081 € que les he generado a través de los enlaces que incluyo he recibido 107 €. En total unos 410 € de este 2020 que me dará para comprar algún juego de la PlayStation y para hacer una donación a varios proyectos de software libre que uso o me parecen importantes. Me gustaría saber para comparar cuántos ingresos generan por publicidad algunos _youtubers_ con un canal medio o pequeño con unos 10K, 5K y 1K suscriptores.

Hay quien cree que añadir un enlace a un artículo me lleva 20 minutos y que 20 € por ese tiempo equivalente a 60 € la hora es un buen precio. Pues no, no es un buen precio, cada artículo son entre 4 y 8 horas de tiempo, multiplica esto por 550 artículos y 7 años de constancia escribiendo todas las semanas un artículo y muchas 2. Realmente el precio no es por el tiempo de insertar el enlace sino por conseguir en base a esfuerzo y trabajo que sea interesante insertarlo.
...
{{< image
    gallery="true"
    image1="image:paypal-saldo.png" optionsthumb1="300x250" title1="Saldo cuenta PayPal"
...
Los artículos los escribo en primera instancia como un borrador que guardo en [Google Docs][google-docs] dónde esté ya marca varias correcciones en palabras mal escritas y con errores, al editar los artículos que hago en formato markdown con el editor [Code][microsoft-visual-studio-code] reviso algunas partes e en muchas ocasiones introducir nuevos errores gramaticales para mejorar la calidad del artículo quitando estos errores un paso que realizo siempre antes de publicarlos es una corrección gramatical, la hacía con el editor de texto [Vim][vim] basado en consola porque no conocía otra forma mejor. Utilizar Vim para la corrección gramatical me suponía salir de Code entrar en Vim realizar la edición cuya navegación por el documento no es lo más rápido y volver al editor Code, esto en ocasiones lo tenía que hacer un par de veces.

Para la funcionalidad de corrección gramatical he instalado en Code una extensión con el diccionario de palabras en español que me permite corregir a medida que escribo, esto es más sencillo, me ahorra algo de tiempo y encuentro más errores que con Vim alguno se me escapaba. He revisado todos los artículos que ya tenía publicados, los 500, con esta extensión y la verdad es que en la mayoría tenía dos o tres gazapos que he corregido.
...
Los últimos meses he estado publicando los artículos que he ido escribiendo esa misma semana casi con ideas sobre la marcha. En otros momentos entre que apuntaba la idea, escribía el borrador y lo publicaba pasaba incluso varios meses o algún año entre cada uno de esos pasos.
...
Alguna vez me he planteado migrar el blog a [AWS][amazon-aws], [Digital Ocean][digital-ocean] o [Linode][linode] más que por necesidad por aprender y tener un dominio propio, no lo he hecho hasta el momento por la comodidad de [GitHub Pages][github-pages] ni tener que dedicar tiempo al mantenimiento de esa infraestructura. También requiere un plan de migración para que tenga el menor impacto posible en cuanto a tráfico o SEO.

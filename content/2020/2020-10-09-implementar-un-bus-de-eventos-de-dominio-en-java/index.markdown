...
{{< code file="DomainEvent.java" language="java" options="" >}}
{{< code file="DomainEventId.java" language="java" options="" >}}
...
{{< code file="DomainEventCollection.java" language="java" options="" >}}
...
Con la implementación del bus de eventos que imprime en la consola se muestra un mensaje cuando se crear una orden de compra. Siguiendo las normas de la arquitectura hexagonal el código debería estar en un servicio o comando de la capa de aplicación.
...
Si un evento incluye el identificativo de la entidad este ha de ser generado con anterioridad. Habitualmente se se delega en la base de datos el generar el identificativo con un autonumérico, hacerlo en el momento de la persistencia impide conocer su identificativo hasta ese momento quizá en el momento de finalizar la transacción. Para solucionar esto una solución es [generar a solicitud del dominio los identificativos de las entidades][blogbitix-493].

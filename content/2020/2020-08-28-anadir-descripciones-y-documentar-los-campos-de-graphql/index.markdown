...
series: ["graphql"]
summary: "A diferencia de una API en REST una API con GraphQL posee un esquema en el que quedan definidos los tipos, propiedades y tipos de esas propiedades. Como documentación en el propio esquema se pueden añadir descripciones a los tipos y propiedades para mayor detalle."
---

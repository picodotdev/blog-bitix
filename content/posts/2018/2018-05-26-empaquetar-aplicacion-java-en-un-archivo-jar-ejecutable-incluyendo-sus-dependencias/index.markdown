...
{{< image
    gallery="true"
    image1="image:java-classpath.webp" optionsthumb1="650x450" title1="Aplicación de ejemplo ejecutada con classpath"
...
{{< code file="Exception.out" language="plain" options="" >}}
...
{{< image
    gallery="true"
    image1="image:java-jar-uberjar.webp" optionsthumb1="650x450" title1="Aplicación de ejemplo ejecutada con uberjar"

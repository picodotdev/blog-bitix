...
{{< image
    gallery="true"
    image1="image:gitlab-runners.webp" optionsthumb1="300x200" title1="Runners"
...
En este ejemplo y con este _pipeline_ el artefacto distribuible de la aplicación y el Javadoc se almacena en GitLab estando accesible para su descarga desde el panel lateral una vez finalizado el _pipeline_.

{{< image
    gallery="true"
    image1="image:pipelines.webp" optionsthumb1="300x200" title1="Pipelines"
    image2="image:pipeline.webp" optionsthumb2="300x200" title2="Pipeline"
    caption="Pipeline" >}}

...
{{< code file="user-parameter-xss.data" language="plain" options="" >}}
...
{{< image
    gallery="true"
    image1="image:xss.webp" optionsthumb1="300x200" title1="XSS"
    image2="image:xss-user.webp" optionsthumb2="300x200" title2="XSS"
    caption="XSS" >}}

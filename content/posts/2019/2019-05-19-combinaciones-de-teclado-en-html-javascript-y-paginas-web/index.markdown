...
{{< image
    gallery="true"
    image1="image:key-combinations-1.webp" optionsthumb1="300x200" title1="Ejemplo combinaciones de teclas"
...
{{< image
    gallery="true"
    image1="image:key-combinations-2.webp" optionsthumb1="200x150" title1="Captura de Ctrl + Shift + s"
    image2="image:key-combinations-3.webp" optionsthumb2="200x150" title2="Captura de Alt + Shift + t, ubica el foco en el campo de texto"
    image3="image:key-combinations-4.webp" optionsthumb3="200x150" title3="Captura de Alt + Shift + b, ejecuta la acción clic del botón"

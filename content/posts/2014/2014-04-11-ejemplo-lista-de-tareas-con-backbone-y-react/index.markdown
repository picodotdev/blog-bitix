...
{{< image
    gallery="true"
    image1="image:backbone-react.webp" optionsthumb1="300x200" >}}
...
Este problema de la función _bind_ ya esta incluido como [petición en PhantomJS](https://code.google.com/p/phantomjs/issues/detail?id=522) y probablemente se resuelva en la versión 2.0.

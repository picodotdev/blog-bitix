...
{{< image
    gallery="true"
    image1="image:doble-barra-botones.webp" optionsthumb1="300x200" title1="Doble barra de botones" >}}
...
{{< code file="ProductoAdmin.gsp" language="plain" options="" >}}

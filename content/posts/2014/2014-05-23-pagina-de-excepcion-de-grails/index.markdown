...
{{< code file="exception.gsp" language="plain" options="" >}}
...
{{< image
    gallery="true"
    image1="image:pagina-excepcion-grails-por-defecto.webp" optionsthumb1="300x200" title1="Página de error por defecto de Grails"
    image2="image:pagina-excepcion-grails-personalizada.webp" optionsthumb2="300x200" title2="Página de error personalizada de Grails" >}}

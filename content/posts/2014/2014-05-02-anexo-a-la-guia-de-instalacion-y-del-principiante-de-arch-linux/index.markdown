...
{{< image
    gallery="true"
    image1="image:instalacion-arch-linux.webp" optionsthumb1="300x200" title1="Menú instalación Arch Linux"
    image2="image:instalacion-arch-linux-prompt.webp" optionsthumb2="300x200" title2="Inicio instalación Arch Linux" >}}
...
{{< code file="script-43.txt" language="plain" options="" >}}
...
{{< code file="script-23.txt" language="plain" options="" >}}
...
{{< code file="script-25.txt" language="plain" options="" >}}
...
{{< code file="script-32.txt" language="plain" options="" >}}
...
{{< code file="script-38.txt" language="plain" options="" >}}
...
{{< image
    gallery="true"
    image1="image:escritorio-gnome.webp" optionsthumb1="300x200" >}}

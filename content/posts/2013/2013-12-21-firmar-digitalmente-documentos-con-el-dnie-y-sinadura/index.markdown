...
sharing: true
comments: true
imagePost: "logotype:dnie.webp"
tags: ["planeta-codigo", "software-libre", "hardware", "software"]
---

{{% post %}}

{{< logotype image1="dnie.webp" title1="DNIe" width1="200" image2="sinadura.webp" title2="Sinadura" width2="200" >}}
...
{{< image
    gallery="true"
    image1="image:instalador-sinadura.webp" optionsthumb1="300x200" title1="Instalador Sinadura" >}}
...
{{< image
    gallery="true"
    image1="image:sinadura.webp" optionsthumb1="300x200" title1="Sinadura" >}}
...
{{< image
    gallery="true"
    image1="image:pin.webp" optionsthumb1="300x200" title1="Preferencias de Sinadura" >}}
...
{{< image
    gallery="true"
    image1="image:preferencias-sinadura.webp" optionsthumb1="300x200" title1="Preferencias de Sinadura" >}}
...
{{< image
    gallery="true"
    image1="image:sinadura-documento-firmado.webp" optionsthumb1="300x200" title1="Documento firmado con Sinadura" >}}
...
{{< code file="preferences-console.properties" language="plain" options="" >}}

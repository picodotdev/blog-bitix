...
{{< image
    gallery="true"
    image1="image:nginx-cache-peticion-miss.webp" optionsthumb1="300x200" title1="Fallo en la cache de Nginx"
    image2="image:nginx-cache-peticion-hit.webp" optionsthumb2="300x200" title2="Acierto en la cache de Nginx" >}}
{{< image
    gallery="true"
    image1="image:nginx-cache-peticion-expired.webp" optionsthumb1="300x200" title1="Expiración en la cache de Nginx"
    image2="image:curl-cache-miss-hit-expired.webp" optionsthumb2="300x200" title2="Fallo, acierto y expiración en la cache de Nginx con curl"

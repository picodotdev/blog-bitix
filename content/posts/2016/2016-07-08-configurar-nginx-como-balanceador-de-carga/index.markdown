...
{{< image
    gallery="true"
    image1="image:nginx-load-balancer-1.webp" optionsthumb1="300x200" title1="Servidor balanceado 172.17.0.2:8080"
    image2="image:nginx-load-balancer-2.webp" optionsthumb2="300x200" title2="Servidor balanceado 172.17.0.3:8080" >}}
{{< image
    gallery="true"
    image1="image:nginx-load-balancer-3.webp" optionsthumb1="300x200" title1="Servidor balanceado 172.17.0.4:8080"

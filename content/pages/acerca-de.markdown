...
* Ofertas de trabajo. Estoy interesado en [Java][java], [Java EE][java-ee], [JBoss][jboss], [WildFly][wildfly], [Tomcat][tomcat], [Apache Tapestry][tapestry], [jOOQ][jooq], [jQuery][jquery], [Backbone.js][backbone], [React][react], [PostgreSQL][postgresql], [GNU][gnu]/[Linux][linux] y software libre.

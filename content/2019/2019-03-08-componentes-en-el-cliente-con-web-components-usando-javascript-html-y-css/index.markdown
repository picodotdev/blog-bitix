...
{{< image
    gallery="true"
    image1="web-components-1.png" optionsthumb1="300x200" title1="Web Components"
    image2="web-components-2.png" optionsthumb2="300x200" title2="Eventos de ciclo de vida Web Components"

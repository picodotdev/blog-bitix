...
{{< image
    gallery="true"
    image1="aplicacion.png" optionsthumb1="300x200" title1="Creando un registro en la base de datos"
    image2="consola.png" optionsthumb2="300x200" title2="Trazas de ejecución del listener" >}}

...
{{< image
    gallery="true"
    image1="resource:javadoc-jdk.png" optionsthumb1="300x200" title1="Documentación Javadoc del JDK"
...
{{< image
    gallery="true"
    image1="resource:javadoc-1.png" optionsthumb1="300x200" title1="Documentación Javadoc"
    image2="resource:javadoc-2.png" optionsthumb2="300x200" title2="Documentación Javadoc"
    caption="Documentación Javadoc del ejemplo" >}}
{{< image
    gallery="true"
    image1="resource:javadoc-archivos.png" optionsthumb1="300x200" title1="Archivos de la documentación Javadoc"

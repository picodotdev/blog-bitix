...
{{< figureproc
    image1="web-cloudingio.png" thumb1="web-cloudingio-thumb.png" options1="2560x1440" optionsthumb1="450x400" title1="Página web de Clouding.io"
...
{{< figureproc
    image1="registro.png" thumb1="registro-thumb.png" options1="2560x1440" optionsthumb1="450x400" title1="Pasos de verificación del registro"
    caption="Registro" >}}
...
{{< figureproc
    image1="panel-administracion.png" thumb1="panel-administracion-thumb.png" options1="2560x1440" optionsthumb1="450x400" title1="Panel de administración"
...
{{< figureproc
    image1="dns.png" thumb1="dns-thumb.png" options1="2560x1440" optionsthumb1="450x400" title1="Administración DNS"
...
{{< figureproc
    image1="servidor.png" thumb1="servidor-thumb.png" options1="2560x1440" optionsthumb1="450x400" title1="Parámetros de acceso de un servidor"
    image2="acceso.png" thumb2="acceso-thumb.png" options2="2560x1440" optionsthumb2="450x400" title2="Parámetros de acceso de un servidor"
    caption="Un servidor y sus parámetros de acceso" >}}
{{< figureproc
    image1="nuevo-servidor.png" thumb1="nuevo-servidor-thumb.png" options1="2560x1440" optionsthumb1="450x400" title1="Nuevo servidor"
...
{{< figureproc
    image1="firewall.png" thumb1="firewall-thumb.png" options1="2560x1440" optionsthumb1="450x400" title1="Reglas de firewall"
...
{{< figureproc
    image1="llaves-ssh.png" thumb1="llaves-ssh-thumb.png" options1="2560x1440" optionsthumb1="450x400" title1="Claves SSH"
    caption="Claves SSH" >}}
...
{{< figureproc
    image1="ajustes.png" thumb1="ajustes-thumb.png" options1="2560x1440" optionsthumb1="450x400" title1="Ajustes, facturación e informes"
...
{{< figureproc
    image1="ssh.png" thumb1="ssh-thumb.png" options1="2560x1440" optionsthumb1="450x400" title1="Acceso mediante SSH"
    image2="consola-vnc.png" thumb2="consola-vnc-thumb.png" options2="2560x1440" optionsthumb2="450x400" title2="Acceso mediante consola VNC"
...
{{< figureproc
    image1="nginx.png" thumb1="nginx-thumb.png" options1="2560x1440" optionsthumb1="450x400" title1="Servidor NGINX"

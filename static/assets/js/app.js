    ...
    if (adblock) {
      ads.each(function(i, e) {
        var html = [
          ...
          ' <p class="text-center"><img src="assets/images/custom/adblockplus.png" alt="Ad Block" title="Ad Block"></p>',
          ' <p>Parece que tienes activado un bloqueador de anuncios.</p>',
          ...
          ' <p>Considera <a href="https://adblockplus.org/es/faq_basics#disable" target="_blank">desactivar el bloqueador de anuncios</a> en <strong>Blog Bitix</strong>.</p>',
          '</div>'
        ].join('');
        var dom = $(html);
